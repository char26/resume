...
\section*{Skills}
Python, JavaScript/TypeScript, Java, Kotlin, C++, Golang, Apache Cassandra/CQL, SQL, AWS, Google Cloud, bash/zsh, Linux (Debian/NixOS), Git, GitHub, Docker, Flask, Graph Databases, Jenkins
...
\begin{flushleft}
  \textbf{SDE Intern} \hfill Jun 2025 - Sep 2025 \\
  Amazon - Seattle, WA \\
